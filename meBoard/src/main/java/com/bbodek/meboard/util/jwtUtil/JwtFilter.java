package com.bbodek.meboard.util.jwtUtil;

import com.bbodek.meboard.controller.account.AccountController;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    public static final String AUTHORIZATION_HEADER = "bbdekToken";
    public static final String BEARER_PREFIX = "BBodek ";
